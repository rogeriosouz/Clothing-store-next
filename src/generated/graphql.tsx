...
export type CategoryQuery = { __typename?: 'Query', category?: { __typename?: 'Category', name: string, products: Array<{ __typename?: 'Product', id: string, name: string, price: number, images: Array<{ __typename?: 'Asset', url: string }> }> } | null };
...
export const SearchDocument = gql`
    query Search($_search: String = "mug") {
  products(where: {_search: $_search}) {
    id
    name
    images {
      url
